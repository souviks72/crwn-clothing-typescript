...
export const addCollectionAndDocuments = async <T extends ObjectToAdd>(
  ...
  //Async functions always return a Promise, since we are not returning anything, Ppromisse is of type void
...
export const getCategoriesAndDocuments = async (): Promise<Category[]> => {
  ...
  ); //casting type because typescript doesnot know what is in our Db, but we do
};
